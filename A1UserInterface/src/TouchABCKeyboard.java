...
public class TouchABCKeyboard extends Keyboard implements ActionListener {
	...
	public TouchABCKeyboard(JTextField field, String input) {
		this.field = field;
		this.input = input;
	...
	public static void main(String[] args) {
		...
		TouchABCKeyboard panel = new TouchABCKeyboard(null,"");
