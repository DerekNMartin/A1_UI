...
public class TouchKeyboard2  extends Keyboard implements ActionListener {
	...
	public static void main(String[] args) {
		JFrame frame = new JFrame("TouchKeyboard2");
		TouchKeyboard2 panel = new TouchKeyboard2();
